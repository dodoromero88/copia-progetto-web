/**Esempio + spunto da  https://www.youtube.com/watch?v=jyib6kLc5SM*/
    ...
    //Form login with Email and Password, sfrutto Jquery ,ma è equivalente   var tmp = document.getElementById('username'); ecc..
     ...
     $(".login form").on("submit", function(event) {
        ...
        firebase.auth().signInWithEmailAndPassword(email, password).then(function(result) {
           ...
           // var userId = user.uid;
            //Create a user profile in the DB after email_verified is verified
            // if(email_verified){
            ...
            //             dbUsers.child(userId).set({ // add a new profile
